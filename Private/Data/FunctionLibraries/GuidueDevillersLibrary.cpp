...
//int UGuidueDevillersLibrary::tri_tri_overlap_test_3d(double p1[3], double q1[3], double r1[3],
//    double p2[3], double q2[3], double r2[3])

// Three-dimensional Triangle-Triangle Overlap Test
int UGuidueDevillersLibrary::tri_tri_overlap_test_3d(FVector VectorP1, FVector VectorQ1, FVector VectorR1,
    FVector VectorP2, FVector VectorQ2, FVector VectorR2)
{
    double p1[3]{ VectorP1.X, VectorP1.Y, VectorP1.Z };
    double q1[3]{ VectorQ1.X, VectorQ1.Y, VectorQ1.Z };
    double r1[3]{ VectorR1.X, VectorR1.Y, VectorR1.Z };
    double p2[3]{ VectorP2.X, VectorP2.Y, VectorP2.Z };
    double q2[3]{ VectorQ2.X, VectorQ2.Y, VectorQ2.Z };
    double r2[3]{ VectorR2.X, VectorR2.Y, VectorR2.Z };
...
int UGuidueDevillersLibrary::coplanar_tri_tri3d(double p1[3], double q1[3], double r1[3],
    double p2[3], double q2[3], double r2[3],
    double normal_1[3]) 
{
    ...
    return tri_tri_overlap_test_2d(FVector2D(P1[0], P1[1]), FVector2D(Q1[0], Q1[1]), FVector2D(R1[0], R1[1]), FVector2D(P2[0], P2[1]), FVector2D(Q2[0], Q2[1]), FVector2D(R2[0], R2[1]));
...
*/
//int UGuidueDevillersLibrary::TriTriIntersect3D(double p1[3], double q1[3], double r1[3],
//    double p2[3], double q2[3], double r2[3],
//    int* coplanar,
...
int UGuidueDevillersLibrary::tri_tri_overlap_test_2d(FVector2D VectorP1, FVector2D VectorQ1, FVector2D VectorR1,
    FVector2D VectorP2, FVector2D VectorQ2, FVector2D VectorR2)
{
    double p1[2]{ VectorP1.X, VectorP1.Y };
    double q1[2]{ VectorQ1.X, VectorQ1.Y };
    double r1[2]{ VectorR1.X, VectorR1.Y };
    double p2[2]{ VectorP2.X, VectorP2.Y };
    double q2[2]{ VectorQ2.X, VectorQ2.Y };
    double r2[2]{ VectorR2.X, VectorR2.Y };
...
int UGuidueDevillersLibrary::ccw_tri_tri_intersection_2d(double p1[2], double q1[2], double r1[2],
